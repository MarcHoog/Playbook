...
if __name__ == '__main__':
    ...
    while True:
        try:
            ...
            print('\n [Error] A Macaddress of one of the given hosts could not be reached. ')
            continue
        except KeyboardInterrupt:
            print(" [ Notice ] CTRL + C Closing the spoof")
            sys.exit('\n [ Notice ]Exciting the Program ')
    ...
    while True:
        try:
            ...
            send_arp_restore(target_ip=gateway_ip, target_hw=gateway_hw, host_ip=victim_ip, host_hw=victim_hw,
                             verbosity=True)
